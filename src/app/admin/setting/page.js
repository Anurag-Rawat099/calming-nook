...
export default function SettingsPage() {
  ...
  const handleSave = async () => {
    try {
      ...
      const method = checkData.success && checkData.property ? "PUT" : "POST";
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <h1 className="text-4xl font-bold mt-3">Property Information</h1>
...
<div className="space-y-6">
  <div>
    ...
    <p className="text-sm text-black/50 mt-1">
      Manage your homestay name, description and room availability.
    </p>
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div>
      ...
      <p className="text-xs text-black/40 mt-2">
        Used to calculate room availability and prevent overbooking.
      </p>
    </div>
  ...
  <Textarea
    ...
    onChange={handleChange}
    placeholder="Describe your property, mountain views, amenities, peaceful environment..."
  />
</div>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-6">Stay Timing</h2>
        ...
        <div>
          <h2 className="text-xl font-semibold mb-6">Website Images</h2>
          ...
          <div className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <Input
                ...
                onChange={(e) =>
                  handleNestedChange("logo", "url", e.target.value)
                }
                placeholder="https://..."
              />
              ...
              <Input
                ...
                onChange={(e) =>
                  handleNestedChange("logo", "publicId", e.target.value)
                }
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Input
                ...
                onChange={(e) =>
                  handleNestedChange("coverImage", "url", e.target.value)
                }
                placeholder="https://..."
              />
              ...
              <Input
                ...
                onChange={(e) =>
                  handleNestedChange("coverImage", "publicId", e.target.value)
                }
                placeholder="cloudinary/public-id"
              />
            </div>
