    ...
    <section className="section">
      ...
      <div className="container-custom">
        ...
        <div className="text-center max-w-2xl mx-auto">
          <p className="uppercase tracking-[6px] text-(--primary) text-2xl">
            Guest Stories
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 mt-16">
          ...
          {testimonials.map((item) => (
            <div key={item.id} className="theme-card p-2">
              ...
              <span className="inline-block mt-6 px-4 py-2 rounded-full bg-[var(--paper-dark)] text-sm">
